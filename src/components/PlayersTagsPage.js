...
import { sortArray, sortBy, sortIcons, taggedPlayers } from '../utils';
...
class PlayersTagsPage extends React.Component {
  ...
  render() {
    ...
    const players = sortArray(taggedPlayers(this.props.data.players), { sort, order });
    return (
      <table>
        <thead>
          <tr>
